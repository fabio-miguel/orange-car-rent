            ...
            <div className="why-us-text-container">
              <div className="why-us-text-container-col-1">
                ...
                <p>
                  ...
                  Renting a quality car has never been so easy and hassle free.
                </p>
                <a href="#home">
                  Find Your Car &nbsp;
              ...
              <div className="why-us-text-container-col-2">
                <div className="why-us-text-container-col-2-box">
                  ...
                  <div className="why-us-text-container-col-2-box-text">
                    <h4>Our Range</h4>
                    <p>
                      Orange Car Rent offers a range of rental cars at a variety
                      of price points, from economy to luxury. If you need a
                      compact hatchback, SUV or a luxury car at a competitive
                      rate, we got it.
                    </p>
                  </div>
                </div>
                ...
                <div className="why-us-text-container-col-2-box">
                  ...
                  <div className="why-us-text-container-col-2-box-text">
                    <h4>The Rental Experience</h4>
                    <p>
                      The most swift and easy transaction you will ever do. No
                      complicated process, no hassle. Simply book what you want,
