        ...
        <div className="container">
          <div className="contact-content">
            <div className="contact-content-text">
              ...
              <p>
                If you have any questions about bookings or reservations, don’t
            ...
            <div className="contact-form">
              <form>
                ...
                <input type="text" placeholder='E.g: "Fabio Miguel"'></input>

                <label>
                  Email <b>*</b>
                </label>
                <input type="email" placeholder="fabio@fabiomiguel.com"></input>
